...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected guru.springframework.brewery.web.model.OrderStatusEnum orderStatusEnumToOrderStatusEnum(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        guru.springframework.brewery.web.model.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = guru.springframework.brewery.web.model.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = guru.springframework.brewery.web.model.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = guru.springframework.brewery.web.model.OrderStatusEnum.PICKED_UP;
            break;
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum1(guru.springframework.brewery.web.model.OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }
